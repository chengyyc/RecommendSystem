# -*- coding: utf-8 -*-
"""
Created on Sat May  2 22:32:36 2020
...
def processData(in_file_name, cust_dict):
	...
	for row in csv.DictReader(in_file_name):
		# use '2015-05-28' and '2015-06-28' which parallels to '2016-05-28' and '2016-06-28' due to the same pattern between years
		...
		if row['fecha_dato'] == '2016-06-28': #especially for testing set
			...
			new_products = [max(x1 - x2,0) for (x1, x2) in zip(target_list, prev_target_list)]  #new_products: newly bought in 2015_06
...
if __name__ == "__main__":
	...
	data_path = "C:/Users/yingy/Desktop/math/Data Mining 5330/project/data/"
